...
//            Observer { newWord -> binding.wordText.text = newWord.toString() })
        gameViewModel.eventGameFinish.observe(viewLifecycleOwner,
            Observer { newEventGameFinish ->
        ...
        gameViewModel.eventBuzz.observe(viewLifecycleOwner,
        Observer { newEventBuzz -> if (newEventBuzz != GameViewModel.BuzzType.NO_BUZZ){
            buzz(newEventBuzz.pattern)
    ...
    private fun gameFinished() {
        ...
        //Toast.makeText(this.activity, "Game has been finished", Toast.LENGTH_SHORT).show()
    }
